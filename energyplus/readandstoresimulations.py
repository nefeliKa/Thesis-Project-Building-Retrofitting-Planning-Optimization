...
# Directory path
output_directory = r'C:\Users\Nefeli\Desktop\thesis_work\Codes\Thesis_Project\TrialFiles\Output\trial_simulation'
...
for file in os.listdir(output_directory):
    ...
    if file.endswith('tbl.htm'):
        ...
        net_energy_mj = site_energy_t[2][3] ## Get the 'Net Site Energy'
